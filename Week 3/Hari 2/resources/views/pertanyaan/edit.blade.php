        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <form action="/posts/{{ $pertanyaan->id }}/update" method="post" role="form">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                    placeholder="Judul" name="judul" value="{{ $pertanyaan->judul }}">
                                @error('judul')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('isi') is-invalid @enderror" id="isi"
                                    placeholder="isi" name="isi" value="{{ $pertanyaan->isi }}">
                                @error('isi')
                                <div class="alert alert-danger my-2">{{ $message }}</div>
                                @enderror
                            </div>
